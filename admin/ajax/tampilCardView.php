...
$jumlahUser = mysqli_query($koneksi, "SELECT * FROM user");
$jumlahUserAktif = mysqli_query($koneksi, "SELECT * FROM user WHERE status = 'aktif'");
$jumlahUserTidakAktif = mysqli_query($koneksi, "SELECT * FROM user WHERE status = 'tidak aktif'");
?>
