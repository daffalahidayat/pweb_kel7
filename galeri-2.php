    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="galeri-2.php" class="nav-item nav-link active">Galeri</a>
                ...
                <a href="profile.php" class="nav-item nav-link nav-contact bg-primary text-white px-5 ms-lg-5">Profile      <i class="bi bi-person-circle"></i></a>
            </div>
        </div>
    </nav>
    <!-- Navbar End -->
