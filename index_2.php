...
<script>
    ...
    json_data.forEach(item => {
        ...
        const popupContent = `<img width="160px" height="120px" src="peternak/foto_profil/${item.foto}" alt="Profil Picture">
            <br><strong>Nama:</strong> ${item.username}
            <br><b>Nomor Telepon:</b> ${item.nohp}
