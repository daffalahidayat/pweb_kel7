        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body py-3">
              <a href="sapi.php" class="d-flex align-items-center gap-2 dropdown-item">
                <i class="ti ti-arrow-left fs-6"></i>
                <p class="mb-0 fs-4">Kembali</p>
              </a><br>
              <h4 class="m-0 font-weight-bold text-success">Form Data - Sapi</h4>
            </div>   
            <div class="card-body">
            <?php
                  if (isset($_GET['id'])) {
            ...
            <form method="POST" action="servernya/update_produk-sapi.php?id=<?php echo $row['id_produk'];?>" enctype="multipart/form-data">
