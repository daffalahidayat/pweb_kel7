            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="kambing.php" class="dropdown-item active">Kambing</a>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                ...
                <h1 class="display-6 text-uppercase mb-0">Katalog Kambing</h1>
            </div>
            <br>
            <div class="row">
                <?php
                ...
                $sql = "SELECT * FROM katalog_produk WHERE jenis = 'kambing'";
                ...
                <?php
                    ...
                    echo "Tidak ada data kambing yang tersedia.";
                }
